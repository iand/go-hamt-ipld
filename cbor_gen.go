...
func (t *Node) MarshalCBOR(w io.Writer) error {
	...
	if err := cbg.WriteMajorTypeHeader(w, cbg.MajArray, uint64(len(t.Pointers))); err != nil {
		return err
	}
...
func (t *KV) MarshalCBOR(w io.Writer) error {
	...
	if err := cbg.WriteMajorTypeHeader(w, cbg.MajByteString, uint64(len(t.Key))); err != nil {
		return err
	}
